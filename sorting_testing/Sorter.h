...
int compare_movie(Movie movie1,Movie movie2){
	...
	if (strcmp(sort_by,"color")==0){
		...
		if (movie1.num_critic_for_reviews == movie2.num_critic_for_reviews){
		...
		if (movie1.director_facebook_likes == movie2.director_facebook_likes){
		...
		if (movie1.actor_3_facebook_likes == movie2.actor_3_facebook_likes){
		...
		if (movie1.actor_1_facebook_likes == movie2.actor_1_facebook_likes){
		...
		if (movie1.num_voted_users == movie2.num_voted_users){
		...
		if (movie1.cast_total_facebook_likes == movie2.cast_total_facebook_likes){
		...
		if (movie1.facenumber_in_poster == movie2.facenumber_in_poster){
		...
		if (movie1.num_user_for_reviews == movie2.num_user_for_reviews){
		...
		if (movie1.actor_2_facebook_likes == movie2.actor_2_facebook_likes){
		...
		if (movie1.imdb_score == movie2.imdb_score){
		...
		if (movie1.aspect_ratio == movie2.aspect_ratio){
		...
		if (movie1.movie_facebook_likes == movie2.movie_facebook_likes){
...
void printMovies(Movie  movies[], int total_movies, char command[]){
	...
	if (strcmp(command,"w")==0){fprintf(outputName, "%s",header);}
